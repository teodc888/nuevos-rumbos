    ...
    <div>
      ...
      >
        ...
        <Typography
          ...
          component="div"
          textAlign="center"
          sx={{ display: { xs: "block", md: "none", sm: "block", lg: "none" } }}
        >
          BIENVENIDO ADMIN
        </Typography>
        ...
        <Box sx={{ width: "100%", marginTop: "3%" }}>
          <Typography variant="h3" component="div" sx={{ mt: "3%", mb: "3%", display: { xs: "none", md: "block", sm: "none", lg: "block" } }}>
            Productos Cargados
          </Typography>
		  <Typography variant="h5" component="div" sx={{ mt: "3%", mb: "3%", display: { xs: "block", md: "none", sm: "block", lg: "none" } }}>
            Productos Cargados
          </Typography>
          <Grid
            container
